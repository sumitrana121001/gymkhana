...
<html lang="en">
  ...
  <div class="card-body my-2">
    <h5 class="card-title">View and Book Supplements</h5>
    <p class="card-text">View the Supplements available and book them.</p>
    <a href="view_bookbike.php" class="btn btn-primary">View/Book Supplements</a>
  </div>
</div>
</div>
...
<div class="col-md-4">
  ...
  <div class="card-body my-2">
    <h5 class="card-title">View Supplements Companies</h5>
    <p class="card-text">View the different companies that are available.</p>
    <a href="view_comp.php" class="btn btn-primary">View Supplements Companies</a>
  </div>
</div>
</div>
