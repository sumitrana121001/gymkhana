...
<html lang="en">
 ...
 ?>
  <h3 class= "text-center my-4" >Add Supplements information</h3>
  ...
  <div class="form-group col-md-6">
    <label for="exampleFormControlTextarea1">Supplements Description</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description"></textarea>
  </div>
  <div class="form-group col-md-6">
  <input type="hidden" name="size" value="1000000" class="form-control">
  <div class="form-group col-md-6">
  <label for="exampleFormControlTextarea1">Supplements Photo</label>
...
<h3 class= "text-center my-4" >Available Supplements details</h3>
<div class="container my-4">
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col">Supplements Photo</th>
          <th scope="col">Supplements Name</th>
          <th scope="col">Company</th>
          <th scope="col">Type</th>
          <th scope="col">Supplements Number</th>
